% -----------------------------------------------
% Template for ACMC
% With thanks to authors of the SMC template
% -----------------------------------------------
...
\def\papertitle{PAPER TEMPLATE FOR THE AUSTRALASIAN COMPUTER MUSIC CONFERENCE}
...
%     {\tt \href{mailto:author1@email.org}{author1@email.org}}}
...
%     {\tt \href{mailto:author2@email.org}{author2@email.org}}}
...
% --------------
 \threeauthors
   ...
   {\thirdauthor} { Affiliation3 \\ %
     {\tt \href{mailto:author3@email.org}{author3@email.org}}}
...
This template includes all the information for formatting manuscripts for the conference.
It was adapted from the proceedings templates for SMC (Sound and Music Computing) and ISMIR.
Please, use either LaTeX or docx templates when preparing your submission.
Please follow these guidelines to give the final proceedings a professional look.

\section{Page size and format}
\label{sec:page_size}

The proceedings will be formatted as A4-size portrait. 
All material on each page should fit within a rectangle of 17.2~cm x 25.2~cm, centred on the page, beginning 2.0~cm from the top of the page and ending with 2.5~cm from the bottom. 
The left and right margins should be 1.9~cm. The text should be in two 8.2~cm columns with a 0.8~cm gutter. 
All text must be in a two-column format, and justified.

Papers must be submitted as PDF documents generated using the provided \LaTeX{} or Word templates.
...
Please use a 10~pt (point) Times font. 
Use sans-serif or non-proportional fonts only for special purposes, such as distinguishing source code.
...
and completely legible. All lines should be thick and dark enough for purposes of reproduction. 
Artwork should not be hand-drawn. 
The proceedings will be distributed in electronic form only, therefore color figures are allowed. 
...
Reference numbers in the text should appear within square brackets, such as in~\cite{doe2023} or~\cite{wizard2022, alien2024}. 
The reference format is the standard IEEE one. 
We highly recommend you use BibTeX to generate the reference list.

\section{Conclusions}

This is where you put the conclusion.
